...
public class ExceptionHandler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// System.out.println("DataAccessException이 발생해 ExceptionHandler가 호출!");
		
		// 서블릿 컨테이너는 HandlableException이 발생하면 요청을 ExceptionHandler으로 재지정함
		// 이 때, ExceptionHandler 서비스 메서드로 넘겨주는 request의 속성(javax.servlet.error.exception)에
		// 발생한 발생한 예외객체를 함께 넘겨준다.
