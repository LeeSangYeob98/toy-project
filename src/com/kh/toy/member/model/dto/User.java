...
public class User {
	...
	// 2. 자바빈 패턴
	// getter/setter
	// 단점 : public 메서드인 setter를 통해 속성을 초기화하기 때문에, 
	//	변경 불가능한 객체(immutable)를 만들 수 없다.
	...
	// 외부에서 직접 생성할 수 있으면 안되고, UserBuilder 이너클래스를 이용해야만 한다.
	...
	// 생성될 User 객체의 속성을 초기화하기 위한 값을 전달받아, 해당 값으로 속성을 초기화하고
	// User 인스턴스를 반환할 innerClass를 만듦
	public static class UserBuilder {
		// user클래스의 속성을 모두 가지고있어야 한다.
		private String userId;
		private String password;
		private String email;
		private String tell;
